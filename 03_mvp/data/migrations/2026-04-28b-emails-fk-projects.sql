-- ----------------------------------------------------------
-- 2026-04-28b-emails-fk-projects.sql — Sprint v0.7-S6.7 (fix S6.42)
--
...
--
-- Le suffixe `b` force l'execution APRES 2026-04-28-emails.sql (qui cree la table emails).
-- Sur DB existante deja a jour : cette migration est nouvelle (pas dans schema_migrations)
-- et tentera l'ALTER qui peut echouer si project_id existe deja → init-db tolere via
-- try/catch dans init-db.js (S6.42).
-- ----------------------------------------------------------
