> **ARCHIVÉ le 2026-04-24** — cette recette a été entièrement exécutée. Dépôt `feycoil/aiCEO` créé, 78 issues migrées, 29 labels + 4 milestones en place (voir `00_BOUSSOLE/CHANGELOG.md` v0.4).
>
> Conservé pour référence si un jour il faut refaire un dépôt propre depuis zéro.
